...
def estimator(data):
  ...
  impact['infectionsByRequestedTime'] = infections_by_time(infected_count, data['timeToElapse:'], data['periodType'])
  severeImpact['infectionsByRequestedTime'] = infections_by_time(severe_infected_count, data['timeToElapse:'], data['periodType'])
